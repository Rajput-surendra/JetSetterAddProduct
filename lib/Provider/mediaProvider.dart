      ...
      if (isNetworkAvail) {
        ...
        if (!error) {
          ...
          if (data.length != 0) {
            ...
            update();
            //print(mediaProvider!.tempList.length.toString());
  ...
  Future<void> uploadMediaAPI(
    ...
    if (isNetworkAvail) {
      try {
        ...
        print(uploadMediaApi.toString()+"url");
        ...
        if (mediaProvider!.selectedImageFromGellery != null) {
          ...
          print('_____mainImagepPath_____${mainImagepPath}_________');
        ...
        print(response.statusCode.toString()+"url");

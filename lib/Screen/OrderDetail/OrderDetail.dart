...
class OrderDetail extends StatefulWidget {
  final String? id,orderDate,payment,otp,orderImages,orderQTY,orderPrice,itemId;
  Function? update;
...
//========================= getDeliveryBoy API =================================
  ...
  Widget build(BuildContext context) {
    // print('___wwwwwww_______${widget.itemId}_________');
                           ...
                           Padding(
                                ...
                                child: Container(
                                  ...
                                  child: Padding(
                                    ...
                                    child: Text(
                                      "${getTranslated(context, "PREFER_DATE_TIME")!}: ${widget.orderDate} - ${widget.orderDate}",
                        ...
                        MediaQuery.removePadding(
                            ...
                            child: ListView.builder(
                                ...
                                itemBuilder: (context, j) {
                                  ...
                                  p++) {
                                    print('____ssssssss______${model!.itemList!.length}_________');
                                    // if (model!.itemList![p]
                                    //         .pickUpLocation ==
                                      ...
                                      Padding(
                                          ...
                                          child: Container(
                                              ...
                                              ListView.builder(
                                                ...
                                                itemBuilder:
                                                    (context, i) {
                                                  print('____sdsssssss______${model!.itemList!.length}_________');
                                                  OrderItem
                        ...
                        Container(
                          ...
                          child: Padding(
                            ...
                            child: Column(
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: [
                                Text("Order Details",style: TextStyle(color: primary,fontWeight: FontWeight.bold),),
                                  ...
                                  child: Row(
                                    children: [
                                      ClipRRect(
                                          ...
                                          child: Image.network("${widget.orderImages}",height: 60,)),
    ...
    if (true) {
      if (isNetworkAvail) {
        try {
          ...
          // }
          parameter[ORDER_ID_ITEM] = widget.id;
          print('_____cccccccc_____${parameter}_________');
          ...
          ApiBaseHelper().postAPICall(updateOrderApi, parameter).then(
                (getdata) async {
              bool error = getdata["error"];
              String msg = getdata["message"];
              print('____parameter______${updateOrderItemApi}_____${parameter}__${widget.id!}__');
              setSnackbar(
                msg,
                context,
              );
...
//             bool error = getdata["error"];
//             String msg = getdata["message"];
//             print('_____aaaaa_____${updateOrderItemApi}_________');
//             setSnackbar(
//               msg,
//               context,
//             );

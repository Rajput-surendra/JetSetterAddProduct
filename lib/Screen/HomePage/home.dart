...
import '../OrderList/Widget/orderIteam.dart';
        ...
        child: isNetworkAvail
            ? Consumer<HomeProvider>(
                builder: (context, value, child) {
                  print(value.getCurrentStatus.toString()+"statuscheck" );
                  chartList = {
                    0: dayData(value),
                    1: weekData(value),
                    2: monthData(value)
                              ...
                              child: Column(
                                ...
                                //   padding: const EdgeInsets.only(
                                  ...
                                  Container(
                                    ...
                                    child:
                                    orderListProvider?.orderList==null ? Center(child: CircularProgressIndicator(color:primary)): orderListProvider?.orderList.length == "0" ?Text("No Order Found!!"):
                                    RefreshIndicator(
                                      ...
                                      child: MediaQuery.removePadding(
                                        ...
                                        ListView.builder(
                                          ...
                                          itemBuilder: (context, index) {
                                            ...
                                            return orderListProvider!.orderList[index].listStatus == "Delivered" ? SizedBox(): item == null || item.itemList!.isEmpty
                                                ? Container()

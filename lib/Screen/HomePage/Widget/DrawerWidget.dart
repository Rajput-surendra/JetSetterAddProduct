...
class DrawerWidget extends StatefulWidget {
  ...
  DrawerWidget({Key? key, this.setstaterofile}) : super(key: key);
...
class _DrawerWidgetState extends State<DrawerWidget> {
  ...
  getStatus(int status) async {
    ...
    var request = http.MultipartRequest('POST', Uri.parse('https://jetsetterindia.com/seller/app/v1/api/online_ofline'));
    request.fields.addAll({
      'user_id':"${context.read<SettingProvider>().CUR_USERID}",

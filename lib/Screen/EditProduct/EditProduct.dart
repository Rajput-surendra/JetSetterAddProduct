    ...
    if (form.validate()) {
      if (editProvider!.productImage == '' &&
        ...
        return false;
          ...
          (editProvider!.selectedTypeOfVideo.toString().toLowerCase() == 'vimeo' ||
              editProvider!.selectedTypeOfVideo.toString().toLowerCase() == 'youtube') &&
          (editProvider!.videoUrl == null || editProvider!.videoUrl.toString().trim().isEmpty)) {
        setSnackbar(
        ...
        return false;
          ...
          editProvider!.selectedTypeOfVideo.toString().toLowerCase() == 'self hosted' &&
          editProvider!.uploadedVideoName == '') {
        setSnackbar(
  ...
  Widget build(BuildContext context) {
    ...
    return WillPopScope(
      ...
      child: Scaffold(
        ...
        body:  getBodyPart(),
       // editProvider!.isLoading ? const ShimmerEffect() :

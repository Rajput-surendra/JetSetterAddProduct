            ...
            await Navigator.push(
              ...
              CupertinoPageRoute(
                builder: (context) => OrderDetail(
                  id: model.id,
                itemId:model.itemList![0].id ,
                 update: update,orderDate: model.orderDate,otp: model.itemList![0].otp,payment: model.payMethod,orderImages: model.itemList![0].image,orderQTY: model.itemList![0].qty,orderPrice: model.itemList![0].price,

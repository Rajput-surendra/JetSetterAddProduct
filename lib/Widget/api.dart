...
final Uri getUserVerifyOtpApi = Uri.parse('${baseUrl}verify_otp');
...
final Uri sendWithDrawalRequestApi = Uri.parse('${baseUrl}send_withdrawal_request');
final Uri getWithDrawalRequestApi = Uri.parse('${baseUrl}get_withdrawal_request');
